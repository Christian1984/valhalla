...
| `use_curvature` | This value is a range of values from 0 to 1, where 0 indicates indifference towards curvy streets, and 1 indicates that curvy streets should be preferred. The default value is 0. |
